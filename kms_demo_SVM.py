...
def main():
    ...
    clf: SVM
    the best score:
    age /   Best testing score: 0.411 /  C : 0.001 / data_v5 / cnum = 5
    gender /   Best testing score: 0.641 /  C : 9.9 / data_all / cnum = 2
    relationship /   Best testing score: 0.511 /  C : 6.071 / data_v4 / cnum = 5
    '''

    #plot confusion matrix at best k of microF1
    best_k = [0.001, 9.9, 6.071]
    best_cnum = [5, 2, 5]
    best_data = [data_v5, data_all, data_v4]
    ...
    for c in range(len(best_cnum)):
        ...
        clf = svm.SVC(random_state=2018, C= best_k[c])
        ...
        plt.savefig('kms_svm_' + demo_list[c] + '.eps', format='eps', dpi=1000)
        #plt.show()
