...
def main():
    ...
    print('data_v5')
    for demo_i in demo_list:
        print(demo_i + ' /   Best testing score: ' + str('%.3f' % max(demo_pred_score[demo_i])) + ' /  k : ' + str(demo_pred_score[demo_i].index(max(demo_pred_score[demo_i]))+1))
    ...
    the best score:
    dataset: data_v5
    age /   Best testing score: 0.427 /  k : 11
    gender /   Best testing score: 0.595 /  k : 18
    relationship /   Best testing score: 0.479 /  k : 4
    '''
    ...
    for k_i in range(len(best_k)):
        ...
        plt.savefig('super_knn_'demo_list[k_i]+'.png', format='png', dpi=1000)
        #plt.show()
    '''
    ...
    plt.savefig("super_knn_microf1.eps", format='eps', dpi=1000)
    #plt.savefig("super_knn_microf1.png", format='png', dpi=1000)
    plt.show()
    '''
